...
#line 3 "/home/liocheng/Install/go_path/src/ownergit/advance/cgo/main.go"
...
int
_cgo_cd6fd6ba8f4d_C2func_div(void *v)
{
	int _cgo_errno;
	struct {
		int p0;
	...
	_cgo_tsan_acquire();
	errno = 0;
	_cgo_r = div(_cgo_a->p0, _cgo_a->p1);
	_cgo_errno = errno;
	_cgo_tsan_release();
...
CGO_NO_SANITIZE_THREAD
void
_cgo_cd6fd6ba8f4d_Cfunc_add(void *v)
{
	struct {
		int p0;
		int p1;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_cd6fd6ba8f4d_Cfunc_div(void *v)
{
	struct {
		int p0;
		int p1;
