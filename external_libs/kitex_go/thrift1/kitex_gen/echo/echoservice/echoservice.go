...
func visitOnewayHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*echo.EchoServiceVisitOnewayArgs)

	err := handler.(echo.EchoService).VisitOneway(ctx, realArg.Req)
	if err != nil {
		return err
	}
...
func newEchoServiceVisitOnewayArgs() interface{} {
	return echo.NewEchoServiceVisitOnewayArgs()
}
...
func (p *kClient) VisitOneway(ctx context.Context, req *echo.Request) (err error) {
	var _args echo.EchoServiceVisitOnewayArgs
	_args.Req = req
